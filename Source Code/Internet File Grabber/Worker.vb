            ...
            For Each urlstring In stringarray
                ...
                Try
                    ...
                    While streamer.Peek() <> -1
                        ...
                        Try
                            While stringtoanalyze.IndexOf("href=") > 0
                                If stringtoanalyze.IndexOf("href=""javascript:") < 0 And stringtoanalyze.IndexOf("href=javascript:") < 0 And stringtoanalyze.IndexOf("href='javascript:") < 0 Then
                                    ...
                                    substring = stringtoanalyze.Substring(stringtoanalyze.IndexOf("href=") + 5, (stringtoanalyze.IndexOf(">", stringtoanalyze.IndexOf("href=") + 5)) - (stringtoanalyze.IndexOf("href=") + 5))
                                    'MsgBox(substring)
                                    stringtoanalyze = stringtoanalyze.Remove(0, (stringtoanalyze.IndexOf(">", stringtoanalyze.IndexOf("href=") + 5)) - 1)
                    ...
                    RaiseEvent WorkerStringMessage("HREF Tag Parsing Complete", "txtStatus")
                Catch ex As Exception
