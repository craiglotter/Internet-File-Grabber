...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'button_download
        '
        Me.button_download.BackColor = System.Drawing.Color.DarkOrange
        Me.button_download.Enabled = False
        Me.button_download.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.button_download.ForeColor = System.Drawing.Color.Black
        ...
        'button_folderbrowse
        '
        Me.button_folderbrowse.BackColor = System.Drawing.Color.DarkOrange
        ...
        'Button_ListFiles
        '
        Me.Button_ListFiles.BackColor = System.Drawing.Color.DarkOrange
        Me.Button_ListFiles.Enabled = False
        Me.Button_ListFiles.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.Button_ListFiles.ForeColor = System.Drawing.Color.Black
        ...
        'txtselectedfile
        '
        Me.txtselectedfile.BackColor = System.Drawing.Color.Orange
        ...
        Me.fullerrors.ForeColor = System.Drawing.Color.Orange
        ...
        'txtParse
        '
        Me.txtParse.ForeColor = System.Drawing.Color.OrangeRed
        ...
        'txtLastDownload
        '
        Me.txtLastDownload.BackColor = System.Drawing.Color.Orange
        ...
        Me.NotifyIcon1.Text = "Internet File Grabber"
        '
        'ContextMenu1
        '
        ...
        Me.MenuItem3.Text = "Show Internet File Grabber"
        '
        'MenuItem4
        '
        ...
        Me.Text = "Internet File Grabber (Build 20050620.5)"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String, Optional ByVal dialog As Boolean = False)
        Try

            Dim disp As Display_Message = New Display_Message("Internet File Grabber Recorded the following error at " & Now() & ":" & vbCrLf & message)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in Internet File Grabber's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_ListFiles.Click
        ...
        Catch ex As Exception
            If fullerrors.Checked = False Then
                Error_Handler(ex.Message.ToString)
            Else
    ...
    Public Sub WorkerErrorHandler(ByVal Message As Exception)
        ...
        Try
            If fullerrors.Checked = False Then
                Error_Handler(Message.Message.ToString, True)
            Else
                Error_Handler(Message.ToString, True)
            End If
        Catch ex As Exception
            If fullerrors.Checked = False Then
                Error_Handler(ex.Message.ToString)
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Internet File Grabber") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Internet File Grabber")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Internet File Grabber", True)
